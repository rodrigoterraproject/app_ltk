...
import com.wolftiger.todolist.R
import com.wolftiger.todolist.databinding.ItemTaskBinding
    ...
    inner class TaskViewHolder(
        ...
        private fun showPopup(item: Task) {
            ...
            popupMenu.setOnMenuItemClickListener {
                when(it.itemId){
                    R.id.action_edit -> listnerEdit(item)
                    R.id.action_delete -> listnerDelete(item)
                }
